...
class CaffeVisApp(BaseApp):
	...
	#pdb.set_trace()	
		...
		#pdb.set_trace()
		#self.state.next_filename
		#self.state.next_frame
	#capas = ['input','conv1','p1','n1','conv2','p2','n2','conv3','conv4','conv5','p5','fc6','fc7','fc8','prob']
	#for capa in range (0,14):
		#default_layer_name = capas[capa]
		#filename = self.state.next_filename[:-4]
		#if not os.path.exists('/home/mbm/Desktop/Aux/models/alexnet/activations/%s'%filename):
			#if not os.path.exists('/home/mbm/Desktop/Aux/models/alexnet/activations/%s'%default_layer_name):
		    #os.makedirs('/home/mbm/Desktop/Aux/models/alexnet/activations/%s'%filename)
		#if not os.path.exists('/home/mbm/Desktop/Aux/models/alexnet/activations/%s/%s'%(filename,default_layer_name)):
			    #if(self.state.next_frame is not None):
			    #pdb.set_trace()
		    #image = scipy.misc.imread('/home/mbm/Desktop/Aux/input_images/val_256/%s.jpg'%filename)
		    #scipy.misc.imsave('/home/mbm/Desktop/Aux/models/alexnet/activations/%s/%s.jpg'%(filename,filename), image)
			    #print self.state.next_frame
			    #print self.state.next_label
			    #print self.state.next_filename
		    #os.makedirs('/home/mbm/Desktop/Aux/models/alexnet/activations/%s/%s'%(filename,default_layer_name))
		    #os.makedirs('/home/mbm/Desktop/Aux/models/alexnet/activations/%s/%s/data'%(filename,default_layer_name))
		    #os.makedirs('/home/mbm/Desktop/Aux/models/alexnet/activations/%s/%s/imgs'%(filename,default_layer_name))
		    #for x in range (0,layer_dat_3D.shape[0]):
			#np.savetxt(('/home/mbm/Desktop/Aux/models/alexnet/activations/%s/%s/data/file%s_%s.out'% (filename,default_layer_name,x,default_layer_name)), layer_dat_3D[x], delimiter=',')
			#np.save(('/home/mbm/Desktop/Aux/models/alexnet/activations/%s/%s/layerdata_%s.npy')%(filename,default_layer_name,default_layer_name), layer_dat_3D)
			#scipy.misc.imsave(('/home/mbm/Desktop/Aux/models/alexnet/activations/%s/%s/imgs/image%s_%s.jpg'%(filename,default_layer_name,x,default_layer_name)), layer_dat_3D[x])
	...
	n_tiles = layer_dat_3D.shape[0]
        ...
        if self.state.pattern_mode != PatternMode.OFF:
            ...
            #np.save('/home/mbm/Desktop/Aux/jeje/a', display_3D)
            #cv2.imwrite('/home/mbm/Desktop/Aux/jeje/a.jpg', display_3D)
